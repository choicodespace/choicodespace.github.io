...
const HomePage = () => {
  ...
  useEffect(() => {
    const dummyNews = [
      {
        title: 'T.O.P\'s New Album "Eclipse" Drops in Just 2 Weeks - Pre-Order Now!',
        url: '/top',
        publishedAt: '2026-03-25',
      },
      {
        title: 'Exclusive Interview: T.O.P Reveals Inspiration Behind "Eclipse" Tracks',
        url: '/top',
        publishedAt: '2026-03-22',
      },
      {
        title: 'Fan Reactions: Teasers for "Midnight Noir" Break the Internet',
        url: '/top',
        publishedAt: '2026-03-20',
      },
      {
        title: 'T.O.P Announces Virtual Fan Meet & Greet for Album Release',
        url: '/top',
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-white">
        <div className="relative w-16 h-16">
          ...
          <span className="absolute inset-0 flex items-center justify-center text-gray-100 font-bold">
            T.O.P
          </span>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white flex flex-col">
      ...
      <section className="flex flex-col md:flex-row flex-grow">
        {/* Image Section */}
        <div className="w-full md:w-1/2 bg-black shadow-2xl border-r border-gray-800">
        ...
        <div className="w-full md:w-1/2 h-full overflow-y-auto px-6 py-12 space-y-8 text-center md:text-left z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
            Welcome to the <span className="text-gray-300">Official Fan Site</span><br />
            of <span className="text-white">Choi Seung‑hyun (T.O.P)</span>
          </h1>
          ...
          <article className="bg-white/95 backdrop-blur-lg rounded-lg p-4 border border-gray-700 shadow-lg">
            <h2 className="text-black font-semibold text-xl mb-2">About This Site</h2>
            <p className="text-gray-600">
              Curated by devoted fans, this is your trusted source for everything T.O.P—music, film, community, and more.
            </p>
          </article>

          <div className="sr-fade bg-black p-5 rounded-xl border-transparent border-gray-500 shadow-lg">
          ...
          <div className="sr-fade bg-white p-5 rounded-xl border border-gray-300 shadow-lg">
            <h2 className="text-black font-semibold text-xl mb-3">Career Highlights</h2>
          ...
          <article className="sr-fade prose prose-neutral prose-lg max-w-none text-gray-900 bg-white p-6 rounded-xl border border-gray-200 shadow">
            <h2 className='text-black font-bold'>Biography & Career Journey</h2>
            <p>
              <strong className='text-black font-bold'>Choi Seung-hyun</strong>, professionally known as <strong className='text-black font-bold'>T.O.P</strong>, is a celebrated South Korean rapper, songwriter, actor, and art collector.
              A former underground rapper known as "Tempo," he rose to fame in 2006 after debuting with the globally influential boy group <strong className='text-black font-bold'>BigBang</strong>.
            </p>
            <p>
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-6">
            <Link to="/community" className="bg-black text-white px-6 py-2 rounded-full shadow hover:bg-gray-800 transition">
              Join the Community
            </Link>
            <Link to="/gallery" className="bg-gray-900 text-white px-6 py-2 rounded-full shadow hover:bg-gray-800 transition">
              Explore Gallery
            </Link>
          </div>
